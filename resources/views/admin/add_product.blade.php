                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style = "resize: none" rows="6" class="form-control" name= "product_desc" id="ckeditor1" placeholder="Password"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputDesc">Nội dung sản phẩm</label>
                                    <textarea style = "resize: none" rows="6" class="form-control" name= "product_content" id="ckeditor2" placeholder="Password"></textarea>
                                </div>
                                <div class="form-group">
