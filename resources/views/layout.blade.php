...
<head>
    ...
    <link rel="stylesheet" href="{{asset('resources/client/css/animate.min.css ')}}">
    <link rel="stylesheet" href="{{asset('resources/client/css/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{asset('resources/client/css/meanmenu.css')}}">
    <link rel="stylesheet" href="{{asset('resources/client/css/animate.min.css')}}">
    <link rel="stylesheet" href="{{asset('resources/client/css/slick.css')}}">
    <link rel="stylesheet" href="{{asset('resources/client/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('resources/client/css/fontawesome-all.min.css')}}">
    <link rel="stylesheet" href="{{asset('resources/client/css/themify-icons.css')}}">
    <link rel="stylesheet" href="{{asset('resources/client/css/nice-select.css')}}">
    <link rel="stylesheet" href="{{asset('resources/client/css/ui-range-slider.css')}}">
    <link rel="stylesheet" href="{{asset('resources/client/css/main.css')}}">
    <link rel="shortcut icon" href="public/frontend/images/">
</head><!--/head-->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xxl-6 col-xl-8 col-lg-8 d-none d-lg-block">
                        <div class="main-menu p-rel d-flex align-items-center justify-content-center">
                            <nav id="mobile-menu">
                                <ul>
                                    <li><a href="{{URL('/trang-chu')}}">Trang chủ</a>
                                    <li class="static">
...
@show
    ...
    <script src="{{asset('resources/client/js/jquery.min.js')}}"></script>
    <script src="{{asset('resources/client/js/waypoints.min.js')}}"></script>
    <script src="{{asset('resources/client/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('resources/client/js/tweenmax.js')}}"></script>
    <script src="{{asset('resources/client/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('resources/client/js/slick.min.js')}}"></script>
    <script src="{{asset('resources/client/js/jquery-ui-slider-range.js')}}"></script>
    <script src="{{asset('resources/client/js/jquery.meanmenu.min.js')}}"></script>
    <script src="{{asset('resources/client/js/isotope.pkgd.min.js')}}"></script>
    <script src="{{asset('resources/client/js/wow.min.js')}}"></script>
    <script src="{{asset('resources/client/js/jquery.scrollUp.min.js')}}"></script>
    <script src="{{asset('resources/client/js/countdown.min.js')}}"></script>
    <script src="{{asset('resources/client/js/jquery.magnific-popup.min.js')}}"></script>
    <script src="{{asset('resources/client/js/parallex.js')}}"></script>
    <script src="{{asset('resources/client/js/imagesloaded.pkgd.min.js')}}"></script>
    <script src="{{asset('resources/client/js/jquery.nice-select.min.js')}}"></script>
    <script src="{{asset('resources/client/js/main.js')}}"></script>
</body>
</html>
